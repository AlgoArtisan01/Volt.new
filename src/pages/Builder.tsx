    ...
    <div className="min-h-screen bg-gray-950 flex flex-col">
      <header className="bg-gray-900 border-b border-gray-800 px-6 py-4 flex items-center justify-between">
        <div className="flex items-center">
          ...
          <div className="h-6 mx-4 border-r border-emerald-600"></div>
          <h2 className="hidden sm:block bg-gradient-to-r from-teal-400 to-emerald-500 bg-clip-text text-transparent font-semibold tracking-wide">
            Website Builder
          </h2>
        </div>
        <div className="flex items-center gap-4">
          <button
            ...
            className="flex items-center gap-2 text-emerald-400 hover:text-white transition-colors mr-4 bg-gray-900 px-3 py-1.5 rounded-md disabled:opacity-50 disabled:cursor-not-allowed"
      ...
      <div className="flex-1 flex overflow-hidden">
            ...
            {!isSidebarCollapsed && (
              <div className="flex-1 overflow-hidden flex flex-col">
                <div className="border-b border-gray-800 p-4">
                  <h3 className="bg-gradient-to-r from-teal-400 to-emerald-500 bg-clip-text text-transparent font-medium mb-1">
                    Your Prompt
                  </h3>
        ...
        >
          <div className="p-4 border-b border-gray-800 flex items-center justify-between">
            <h3 className="bg-gradient-to-r from-teal-400 to-emerald-500 bg-clip-text text-transparent font-medium mb-1">Files</h3>
            <button
